...
def imprimir(lista:List[Int],columnas: Int, filas: Int){
  ...
  val tableroRelleno=rellenarTab(tablero,5)       //> tableroRelleno  : List[Int] = List(4, 0, 0, 0, 0, 7, 0, 0, 0)
  ...
  obtener(tableroRelleno,1)                       //> res1: Int = 4
  obtener(tableroRelleno,2)                       //> res2: Int = 0
  obtener(tableroRelleno,3)                       //> res3: Int = 0
  obtener(tableroRelleno,4)                       //> res4: Int = 0
  ...
  eliminarSumar(tableroRelleno,1)                 //> res7: List[Int] = List(0, 0, 0, 0, 0, 7, 0, 0, 0)
  eliminarSumar(tableroRelleno,2)                 //> res8: List[Int] = List(4, 0, 0, 0, 0, 7, 0, 0, 0)
  eliminarSumar(tableroRelleno,3)                 //> res9: List[Int] = List(4, 0, 0, 0, 0, 7, 0, 0, 0)
  eliminarSumar(tableroRelleno,4)                 //> res10: List[Int] = List(4, 0, 0, 0, 0, 7, 0, 0, 0)
  eliminarSumar(tableroRelleno,5)                 //> res11: List[Int] = List(4, 0, 0, 0, 0, 7, 0, 0, 0)
 ...
 */
 ...
 if(!tablero.isEmpty){
  	if (tablero.head>0){
  		if(obtener(tablero,columnas+1)==0) moverArriba(reverse(poner2(eliminarSumar(tablero,1),tablero.head,columnas+1)),columnas)
 ...
 imprimir(moverArriba(tableroRelleno,3),3,3)
  ...
  imprimir(reverse(tableroRelleno),3,3)
